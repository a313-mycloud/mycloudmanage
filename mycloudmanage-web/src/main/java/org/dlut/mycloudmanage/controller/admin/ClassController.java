...
public class ClassController extends BaseController {
	...
	public String adminClassList(HttpServletRequest request,
		...
		Pagination<ClassDTO> pageClassDTO = this.classBiz
				.query(queryClassCondition);
		if (pageClassDTO.getTotalPage() >= 1
				&& (currentPage < 1 || currentPage > pageClassDTO
						.getTotalPage()))
	...
	public String addClassForm(HttpServletRequest request,
	...
	public String addClass(HttpServletRequest request,
			HttpServletResponse response, ModelMap model, String className,
	 ...
	 * this.hostBiz.query(queryHostCondition2);
	 * 
